...
| Демо/сдача | `docs/`, `notebooks/P4_interface_report.ipynb` | P4 | видео ≤5 мин, презентация, живая ссылка, архив кода | 🟡 PPTX/каркас готов, финальные ссылки/видео заполнить |
